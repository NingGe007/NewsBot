...
{{
  ...
  "reason": "<用中文写2-3句通俗点评。要求：把事情说清楚+把因果逻辑讲透+给出判断。像老股民跟朋友说'xxx发生了，这意味着xxx，所以xxx'。不要用序号，不要写教科书分析，就像微信里跟哥们解释清楚一件事。例如：'微软突然追加100亿算力投入点名要英伟达的卡，说明AI需求比预期还猛，NVDA下季度数据中心收入铁定超预期，短期大概率冲新高。'>"
}}

注意：
- reason 要通俗、有逻辑、一语道破，不要只写结论也不要写长篇大论
